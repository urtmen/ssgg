...
descElem.innerHTML = `
    ...
    ${descSets[data[key]]?.debuffs ? `<p><span class="type">Дебафф</span> ${descSets[data[key]]?.debuffs}</p>`}
    ${descSets[data[key]]?.buffs ? `<p><span class="type">Бафф</span> ${descSets[data[key]]?.buffs}</p>` : ''}
    ${descSets[data[key]]?.specroll ? `<p><span class="type">Особый ролл</span> ${descSets[data[key]]?.specroll}</p>` : ''}
