...
descElem.innerHTML = `
    ...
    ${descSets[data[key]]?.buffs ? `<p><span class="buffs">Дебафф</span> ${descSets[data[key]]?.debuffs}</p>`}
    ${descSets[data[key]]?.debuffs ? `<p><span class="debuffs">Бафф</span> ${descSets[data[key]]?.buffs}</p>` : ''}
